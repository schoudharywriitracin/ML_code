# -*- coding: utf-8 -*-
"""
Created on Wed Jul  9 01:22:24 2025
...
# Set font to Times New Roman and bold globally
...
train_scores, validation_scores = validation_curve(best_model, X_scaled, y, param_name=param_name, param_range=param_range, cv=5, scoring='neg_mean_squared_error')
